...
The [Recipe reference](https://rogercibrian.github.io/notapkgtool/recipe-reference/#discovery-configuration) defines
their fields;
[Common tasks](https://rogercibrian.github.io/notapkgtool/common-tasks/#create-a-recipe-for-a-github-release-app)
walks through a recipe for each.

## Contributing

See [Contributing](https://rogercibrian.github.io/notapkgtool/contributing/) to suggest features or report problems.
